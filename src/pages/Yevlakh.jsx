...
function Yevlakh() {
  ...
  const url = 'https://api.open-meteo.com/v1/forecast?latitude=40.6183&longitude=47.1501&hourly=temperature_2m,weather_code,visibility,uv_index,wind_speed_10m&timezone=auto&forecast_days=1'
  fetch(url)
    .then(response => {
