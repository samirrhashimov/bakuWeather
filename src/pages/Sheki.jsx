...
function Sheki() {
  ...
  const url = 'https://api.open-meteo.com/v1/forecast?latitude=41.1919&longitude=47.1706&hourly=temperature_2m,weather_code,visibility,uv_index,wind_speed_10m&timezone=auto&forecast_days=1'
  fetch(url)
    .then(response => {
