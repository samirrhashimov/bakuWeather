...
function Nakhchivan() {
  ...
  const url = 'https://api.open-meteo.com/v1/forecast?latitude=39.2089&longitude=45.4122&hourly=temperature_2m,weather_code,visibility,uv_index,wind_speed_10m&timezone=auto&forecast_days=1'
  fetch(url)
    .then(response => {
